 ...
 */
int count_neighbors(const int rows, const int cols, cell field[rows][cols], int r, int c)
{
	int count = 0;
 ...
 */
int cell_states(const int rows, const int cols, cell field[rows][cols], int r, int c)
{
 ...
 * Output:      The field array is updated.
 */
void update_field(const int rows, const int cols,cell field[rows][cols])
{
	for(int r = 0; r < rows; r++){
		for(int c = 0; c < cols; c++){
